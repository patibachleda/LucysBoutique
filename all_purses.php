<!-- displays all the purses available on the site -->

<?php
// connects to the database and gets the infor needed
	$db = mysqli_connect('127.0.0.1','root','', 'lucysboutique');
	$sql = "SELECT Name, Pic1 FROM items_db WHERE Category LIKE '%Purses%' and Sold != 1";
...
<html>
	...
	<body>
		...
		<!-- title graphic -->
		<p style = "text-align: center;"><img src = "purses.png"></p>
